...
const Sidebar = () => {
  return (
    <aside className="h-screen grid grid-rows-[3rem_calc(100vh-3rem)]">
      <Header parent="sidebar" />

      <div className="bg-neutral-300 border-2 border-neutral-300 border-r-neutral-400 pt-6 space-y-10">
